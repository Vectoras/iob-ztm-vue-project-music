  ...
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      ...
      <div
        ...
        @gragleave.prevent.stop="is_dragover = false"
...
<script>
  import { storage as firebaseStorage, auth, songsCollection } from "@/includes/firebase";
      ...
      upload($event) {
        ...
        files.forEach((file) => {
          ...
          task.on(
            ...
            // callback function for failure/error
            (error) => {
